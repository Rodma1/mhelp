    ...
    <div class="change">
      <div class="box">
        ...
        <div class="right" @click="change">
          <img
            src="@/assets/img/example/cancel.png"
            alt=""
            v-if="del"
            @click="clear"
          />
          <img src="@/assets/img/example/show.png" alt="" v-if="isShow" />
          <img src="@/assets/img/example/hide.png" alt="" v-else />
        </div>
      </div>
      <div class="box">
        ...
        <div class="right" @click="change2">
          <img
            ...
            @click="clear2"
          />
          <img src="@/assets/img/example/hide.png" alt="" v-if="isShow2" />
          <img src="@/assets/img/example/show.png" alt="" v-else />
        </div>
      </div>
      <div class="tips">
